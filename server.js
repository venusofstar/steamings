...
// Load streams from file or initialize default
let streams = {};
if (fs.existsSync(DATA_FILE)) {
  streams = JSON.parse(fs.readFileSync(DATA_FILE, "utf-8"));
} else {
  streams = {
    kapamilya: "https://manifest.googlevideo.com/api/manifest/hls_variant/expire/1765826181/ei/JQpAaYenG67H0-kP37Ct-Ag/ip/126.209.53.186/id/rc4KfaBrGIc.1/source/yt_live_broadcast/requiressl/yes/xpc/EgVo2aDSNQ%3D%3D/file/index.m3u8",
